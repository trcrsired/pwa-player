...
const EN_TRANSLATIONS = {
    ...
    normal: "Normal",
    large: "Large",
    skipInitial: "Skip Initial (sec)",
    skipMax: "Skip Max (sec)",
    skipPercentMax: "Skip Percent Max (%)",
    skipAccelTime: "Skip Accel Time (sec)",
    skipSettingsHint: "Skip forward/backward: initial skip amount, maximum skip, percentage of video duration, and time to reach maximum speed.",
